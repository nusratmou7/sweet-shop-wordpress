 ...
 */
function restro_cafe_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 *
 */
function restro_cafe_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function restro_cafe_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function restro_cafe_sanitize_select( $input, $setting ) {
 ...
 * 
 */
function restro_cafe_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 * 
 */
function restro_cafe_sanitize_number_range( $number, $setting ) {
 ...
 */
function restro_cafe_sanitize_html( $html ) {
 ...
 */
function restro_cafe_sanitize_sort( $input ) {
