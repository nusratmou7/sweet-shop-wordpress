...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="featured-image" style="background-image: url('<?php echo esc_url( $img_url ); ?>');">
	    ...
	    <div class="entry-meta">
	        <?php
			$enable_archive_author = get_theme_mod( 'restro_cafe_enable_archive_author', false );
            ...
            <?php
				...
				if ( 'excerpt' === $archive_content_type ) {
			        ...
			        <div class="read-more-link">
					    <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod( 'restro_cafe_archive_excerpt', esc_html__( 'View the post', 'restro-cafe' ) ) ); ?></a>
					</div><!-- .read-more -->
				<?php
				} else {
					the_content( sprintf(
